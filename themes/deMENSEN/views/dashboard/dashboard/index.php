...
// Add getSpace() method to the dashboard controller
$controller = Yii::app()->getController();
$controller->space = $space;

// Copied view from /protected/modules_core/space/views/space/_layout.php
// Replaced $content with view from /protected/modules_core/space/views/space/index.php
// Replaced '$this->getSpace()' with '$space'
